!function(n) {
  ...
  t.prototype.initMenu = function() {
      ...
      n(".side-nav a").each(function() {
          ...
          this.href == o && (n(this).addClass("active"),
...
function(a) {
  ...
  t.prototype.init = function() {
      var e = this;
      "true" == document.body.getAttribute("data-rightbar-onstart") && (localStorage.getItem("_HYPER_VISITED") || (localStorage.setItem("_HYPER_VISITED", !0),
...
function(a) {
  ...
  t.prototype._getStoredConfig = function() {
      ...
      return "condensed" === a ? t.isCondensed = !0 : "scrollable" === a && (t.isScrollable = !0),
      t
  }
  ,
...
function(n) {
  ...
  t.prototype.init = function() {
      ...
      window.sessionStorage && t && t.hasOwnProperty("showRightSidebarOnStart") && t.showRightSidebarOnStart && (sessionStorage.getItem("_HYPER_VISITED_") || (n.RightBar.toggleRightSideBar(),
      ...
      a && a.addEventListener("click", function() {
          ...
          e = "success",
          (a = document.createElement("div")).innerHTML = '<div class="alert alert-' + e + ' alert-dismissible" role="alert">' + t + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>',
          o.append(a)
      }),

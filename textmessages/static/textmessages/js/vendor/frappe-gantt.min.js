var Gantt = function() {
    ...
    const t = {
        ...
        ptBr: ["Janeiro", "Fevereiro", "Mar챌o", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"],
        fr: ["Janvier", "F챕vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Ao청t", "Septembre", "Octobre", "Novembre", "D챕cembre"],
        tr: ["Ocak", "힇ubat", "Mart", "Nisan", "May캇s", "Haziran", "Temmuz", "A휓ustos", "Eyl체l", "Ekim", "Kas캇m", "Aral캇k"],
    ...
    class p {
        ...
        setup_wrapper(t) {
            ...
            if ("string" == typeof t && (t = document.querySelector(t)), t instanceof HTMLElement) s = t, e = t.querySelector("svg");
                ...
                if (!(t instanceof SVGElement)) throw new TypeError("Frapp챕 Gantt only supports usage of a string CSS selector, HTML DOM element or SVG DOM element for the 'element' parameter");
                e = t
            }
